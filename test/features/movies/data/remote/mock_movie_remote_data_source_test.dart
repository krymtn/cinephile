...
void main() {
  ...
  setUp(() {
    dataSource = MockMovieRemoteDataSource(latency: Duration.zero);
  });

  group('MockMovieRemoteDataSource → PagedDto<MovieDto>', () {
    test('now_playing parses dates and first movie', () async {
    ...
    test('popular has no date window and parses first movie', () async {
    ...
    test('top_rated parses first movie', () async {
    ...
    test('upcoming parses dates and first movie', () async {
